...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are the AI assistant for "After Brakes", a vehicle service marketplace in Chennai, India.
You help users diagnose vehicle issues, recommend solutions, and find mechanics.
